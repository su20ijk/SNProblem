...
public class Atm {
private BillClass[] Level= {new BillClass(100, 10),new BillClass(50, 10),new BillClass(20, 10),new BillClass(10, 10),new BillClass(5, 10),new BillClass(1, 10)};
private int totalValue;
public Atm() {
	totalValue=1860;
}
public void restock() {
	Level[0]=new BillClass(100, 10);
	Level[1]=new BillClass(50, 10);
	Level[2]=new BillClass(20, 10);
	Level[3]=new BillClass(10, 10);
	Level[4]=new BillClass(5, 10);
	Level[5]=new BillClass(1, 10);
	totalValue=1860;
}
